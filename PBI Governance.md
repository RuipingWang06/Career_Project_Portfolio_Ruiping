...
# **Contribution**
As a **Python/ETL developer**, I delivered production-ready **Python** and **SQL scripts**, contributed to **data model design standards**, and helped establish **Snowflake development workflows** and **stored-procedure best practices**.

**Python Script 3 Script:** Triggered the AIP process to extract and deliver metadata into AWS S3.
<img width="1390" height="1008" alt="image" src="https://github.com/user-attachments/assets/d7fb4a95-2b4c-432d-b8c4-31798198d66b" />

**Snowflake ETL SQL Development 20 Scripts:**  
